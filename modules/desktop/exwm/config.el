...
(exwm-input-set-key (kbd "H-SPC") #'jethro/launch)
(exwm-input-set-key (kbd "H-p") #'password-store-copy)
(exwm-input-set-key (kbd "C-x t") #'vterm)
(exwm-input-set-key (kbd "H-t a") #'jethro/switch-to-agenda)
(exwm-input-set-key (kbd "H-t m") #'notmuch)
(exwm-input-set-key (kbd "H-c") #'jethro/org-inbox-capture)
(exwm-input-set-key (kbd "H-f") #'counsel-find-file)
(exwm-input-set-key (kbd "H-F") #'counsel-locate)
(exwm-input-set-key (kbd "H-<tab>") #'jethro/switch-to-last-buffer)
...
(exwm-input-set-key (kbd "H-b") #'jethro/exwm-ibuffer)

(exwm-input-set-key (kbd "<H-up>") 'windmove-up)
(exwm-input-set-key (kbd "<H-down>") 'windmove-down)
(exwm-input-set-key (kbd "<H-right>") 'windmove-right)
(exwm-input-set-key (kbd "<H-left>") 'windmove-left)
